...
entity-heater-examined = 当前设为{ $setting ->
...
entity-heater-switch-setting = 切换至{ -entity-heater-setting-name(setting: $setting) }
entity-heater-switched-setting = 已切换至{ -entity-heater-setting-name(setting: $setting) }。
