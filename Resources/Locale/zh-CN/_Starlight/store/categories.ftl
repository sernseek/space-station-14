...
store-category-secret = 秘密

# Changeling
store-ling-category-combat = 战斗
store-ling-category-sting = 刺击
store-ling-category-utility = 实用

store-category-cantrips-standard = 标准戏法

# Uplinks
store-category-cybernetics = 赛博改造
store-category-dagd = 荣耀
