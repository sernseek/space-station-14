magillitisserum-implant-activated-user = 你变回猿猴，感觉肌肉膨胀，毛发也开始生长。
magillitisserum-implant-activated-others = {CAPITALIZE(THE($entity))}的身体膨胀，毛发迅速生长。糟了！
portal-implant-action-popup = 此操作会将你传送到极远处！再次使用以确认。
death-acidifier-implant-activate-gear = 你的装备开始溶解！
...
roles-antag-mind-controlled-name = 受心智控制者
roles-antag-mind-controlled-objective = 服从控制者的命令。
