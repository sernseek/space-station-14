...
changelog-author-changed = [color=#EEE]{ $author }[/color] 的更改：
changelog-today = 今天
...
changelog-button-new-entries = 更新日志（有新内容！）

changelog-tab-title-Changelog = 更新日志
changelog-tab-title-ChangelogStarlight = STARLIGHT 更新日志
changelog-tab-title-Admin = 管理
changelog-tab-title-Maps = 地图
changelog-tab-title-Rules = 规则

cmd-changelog-desc = 打开更新日志。
cmd-changelog-help = 用法：changelog
