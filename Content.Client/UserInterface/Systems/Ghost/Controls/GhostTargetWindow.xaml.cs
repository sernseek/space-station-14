    ...
    public sealed partial class GhostTargetWindow : DefaultWindow
    {
        ...
        public void UpdateWarps(IEnumerable<GhostWarp> warps)
        {
            ...
            _warps = warps
                ...
                .ThenBy(w => w.IsWarpPoint ? MapStringLocalizer.Localize(w.DisplayName) : w.DisplayName, Comparer<string>.Create( // zh-CN
                    (x, y) => string.Compare(x, y, StringComparison.Ordinal)))
                .Select(w =>
                {
                    var name = w.IsWarpPoint
                        ? Loc.GetString("ghost-target-window-current-button", ("name", MapStringLocalizer.Localize(w.DisplayName))) // zh-CN
                        : w.DisplayName;
