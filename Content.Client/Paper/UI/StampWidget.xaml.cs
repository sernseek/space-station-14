      ...
      public StampDisplayInfo StampInfo {
        set {
            ...
            if (value.Type == StampType.Signature && value.Font != null)
            {
                ...
                // zh-CN: handwriting faces carry no CJK glyphs; stack the CJK fallback so
                // Chinese character names still sign, while Latin names keep the script look.
                StampedByLabel.FontOverride = resCache.GetFont(
                    new[] { value.Font, "/Fonts/NotoSansSC/NotoSansCJKsc-Regular.otf" }, 45);
            }
            else
            {
